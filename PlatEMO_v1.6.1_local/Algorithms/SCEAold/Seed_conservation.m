function [Population] = Seed_conservation(Population,Seed_population,Species,N,mod,Front,Global,Z,ZD,Zmin,Front_Zmin,Front_ZDmin,center)
...
%         end
        if Global.evaluated < Global.evaluation
            for i = 1:length(Seed_population)
                Population = [Population Seed_population(i).p];
            end
        end
