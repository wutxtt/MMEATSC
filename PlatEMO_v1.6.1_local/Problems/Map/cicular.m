function varargout = cicular(Operation,Global,input)
% <problem> <MMPPO>
...
%--------------------------------------------------------------------------
    ...
    switch Operation
        case 'init'
            Global.M        = 2;
            Global.D        = 2;% x1=theta x2=time
            Global.lower    = [0.1,0.05];
            Global.upper    = [2*pi-0.1,100];
        ...
        case 'value'
            ...
            for i=1:N
                oev1 = [8000,0,0,0,0,pi];
                oev2 = [15000,0,0,0,0,pi+PopDec(i,1)];
                mu=42828;
                ...
                PopObj(i,1) = norm(dvi) + norm(dvf);
                PopObj(i,2) = tof/24/60/60;
            end
            PopCon = [];
